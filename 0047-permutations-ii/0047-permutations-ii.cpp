...
private:
    void backtrack(vector<int>& nums, vector<bool>& used, vector<int>& current, vector<vector<int>>& result) {
        ...
        for (int i = 0; i < nums.size(); ++i) {
            ...
            // and the previous element hasn't been used in this branch, skip it to avoid duplicate branches
...
public:
    vector<vector<int>> permuteUnique(vector<int>& nums) {
        ...
        // Sort the array to bring duplicate elements adjacent to each other
